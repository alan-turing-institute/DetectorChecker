...
```{r}
pilatus_detector <- create_dectector("Pilatus")
```
...
plot_detector_damaged(detector = pilatus_detector, caption = TRUE)

plot_detector_module_damaged(detector = pilatus_detector, col = 4, row = 5, caption = TRUE)
```

#### XML format

```{r}
detector_perkin <- create_dectector("PerkinElmerFull")
...
plot_detector_module_damaged(detector = detector_perkin, col  =11, row =2)
```

#### HDF

```{r}
detector_exc <- create_dectector("Excalibur")
...
plot_detector_module_damaged(detector_exc, col = 1, row = 6)
```
...
```{r}
detector_pilatus <- create_dectector("Pilatus")
