...
#                          "badpixel_mask.tif")
#
#   pix_matrix <- load_pix_matrix(layout = pilatus_layout, file_path = dead_path)
#
...
#   plot_layout_damaged(layout = pilatus_layout, pix_dead = pix_dead,
#                       file_path = test_out_path)
#
...
#
#   pix_matrix <- load_pix_matrix(layout = perkinelmerfull_layout,
#                                 file_path = dead_path)
#
#   pix_dead <- dead_pix_coords(pix_matrix)
#
...
#
#   # Visualizing damaged pixels
#   plot_layout_damaged(layout = perkinelmerfull_layout, pix_dead = pix_dead,
#                       file_path = test_out_path)
#
#   # Check whether the file was created
#   expect_that(file.exists(test_out_path), is_true())
...
#                                         "pixelmask.fem6.hdf"))
#
#   pix_matrix <- load_pix_matrix(layout = excalibur_layout, file_path = dead_paths)
#
#   pix_dead <- dead_pix_coords(pix_matrix)
#
#   # output file
...
#
#   # Visualizing damaged pixels
#   plot_layout_damaged(layout = excalibur_layout, pix_dead = pix_dead,
#                      file = test_out_path)
#
#   # Check whether the file was created
#   expect_that(file.exists(test_out_path), is_true())
...
test_that("Pilatus", {
  ...
  perform_glm(as.vector(pix_matrix) ~ as.vector(dist))
