...
# Arrows plot
detectorchecker::plot_layout_arrows(layout = layout, file_path = "perkinelmerfull_arrows.jpg")
```

![PerkinElmerFull arrows](perkinelmerfull_arrows.jpg)
# Angles
...
# Arrows plot
detectorchecker::plot_layout_angles(layout = layout, file_path = "perkinelmerfull_arrows.jpg")
```

![PerkinElmerFull arrows](perkinelmerfull_angles.jpg)
