...
detectorchecker:::plot_layout_density(layout = layout_perkin, adjust = 0.5, row = 1, col = 2)
```
...
detectorchecker:::plot_layout_arrows(layout = layout_perkin, row = 1, col = 5)
```
...
detectorchecker:::plot_layout_angles(layout = layout_perkin, row = 1, col = 5)
```
