...
```{r}
user_def_layout <- readin_layout("/Users/tlazauskas/Desktop/user-defined.dc")
...
plot_kfg(layout = layout_perkin, func = "K")
plot_kfg(layout = layout_perkin, func = "F")
plot_kfg(layout = layout_perkin, func = "G")

plot_kfg(layout = layout_perkin, func = "K", row = 1, col = 5, caption = FALSE)
plot_kfg(layout = layout_perkin, func = "F", row = 1, col = 5, caption = FALSE)
plot_kfg(layout = layout_perkin, func = "G", row = 1, col = 5, caption = FALSE)
```
...
plot_kfg(layout = layout_pilatus, func = "Kinhom")
plot_kfg(layout = layout_pilatus, func = "Finhom")
plot_kfg(layout = layout_pilatus, func = "Ginhom")

plot_kfg(layout = layout_pilatus, func = "Kinhom", row = 1, col = 5, caption = FALSE)
plot_kfg(layout = layout_pilatus, func = "Finhom", row = 1, col = 5, caption = FALSE)
plot_kfg(layout = layout_pilatus, func = "Ginhom", row = 1, col = 5, caption = FALSE)
```
