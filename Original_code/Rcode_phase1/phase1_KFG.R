...
dirOut <- paste(dirAnalysis, "Output_phase1/Phase1_KFG/Misc/", sep="")
if (Layout$name == "Pilatus"){ 
  dirOut <- paste(dirAnalysis, "Output_phase1/Phase1_KFG/Pilatus/", sep="")
}

if (substring(Layout$name,1,11) == "PerkinElmer"){
  dirOut <- paste(dirAnalysis, "Output_phase1/Phase1_KFG/",Layout$name,Layout$date,"/", sep="")
}
