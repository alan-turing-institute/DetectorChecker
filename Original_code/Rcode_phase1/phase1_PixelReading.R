...
setwd(dirAnalysis)
dirData <- "/Users/julia/Dropbox/Research/Projects2014+/DetectorChecker/Phase1/Data/"
...
T <- readTIFF(paste(dirData, "Pilatus/", "badpixel_mask.tif", sep=""))
...
if (Layout$detector.height != dim(T)[2]){
  cat("Error: Number of rows in row data file (tif) incorrect.
...
k <- 4 # default choice, may choose any k in 1:6 # done testrun for 5,6,1, 2,3
