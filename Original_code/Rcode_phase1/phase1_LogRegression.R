...
#
# INPUT: - Tbin (dead pixel mask built in phase1_ReadingPixels), 
...
dirOut <- paste(dirAnalysis, "Output_phase1/Phase1_LogRegression/Misc/", sep="")
if (Layout$name == "Pilatus"){ 
  dirOut <- paste(dirAnalysis, "Output_phase1/Phase1_LogRegression/Pilatus/", sep="")
}

if (substring(Layout$name,1,11) == "PerkinElmer"){
  dirOut <- paste(dirAnalysis, "Output_phase1/Phase1_LogRegression/",Layout$name,Layout$date,"/", sep="")
}
