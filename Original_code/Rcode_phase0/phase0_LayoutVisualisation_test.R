# phase0_LayoutVisualisation_test.R: JAB 2018/07/09, edited WSK 2018/07/24
#
# CONTENT:
# LIBRARIES, PATHS 
# AUXILIARY FUNCTIONS
...
dirPlots <- file.path(location, "Output_phase0", "Phase0_LayoutVisualisation")
...
output.file <- file.path(dirPlots, paste("layout_", Layout$name, ".pdf", sep=""))
print(paste("Graphical outout to ",output.file))
pdf (output.file)
